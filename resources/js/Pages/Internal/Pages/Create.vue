    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-semibold text-warm-900 font-display">New Page</h1>
                    <p class="text-sm text-warm-500 mt-0.5">Create a static content page</p>
                </div>
            </div>
        </template>
        ...
        <form @submit.prevent="submit" class="flex flex-col lg:flex-row gap-6 items-start">
            ...
            <div class="flex-1 min-w-0 bg-white border border-warm-200 rounded-2xl p-7 shadow-sm space-y-5">
                ...
                <div>
                    ...
                    <input v-model="form.slug" type="text" required placeholder="about-us"
