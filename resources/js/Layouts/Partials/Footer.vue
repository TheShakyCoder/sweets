...
<template>
    <footer class="bg-warm-900 text-white">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
            <div class="grid md:grid-cols-4 gap-10 mb-10">
                ...
                <div>
                    <p class="text-white/70 text-xs font-semibold uppercase tracking-widest mb-4">Quick Links</p>
                    <ul class="space-y-2">
                        <li v-for="link in navLinks" :key="link.label">
                            <a :href="link.href" class="text-white/60 text-sm hover:text-white transition-colors">{{
                                link.label }}</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    <p class="text-white/70 text-xs font-semibold uppercase tracking-widest mb-4">Get in Touch</p>
                    <ul class="space-y-2 text-sm text-white/60 mb-6">
                        ...
                        <li>
                            <a :href="'mailto:' + page.props.site.email" class="hover:text-white transition-colors">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a :href="page.props.site.social?.facebook" target="_blank" rel="noopener"
                            class="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-[#1877F2]/50 transition-colors"
                            aria-label="Facebook">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                        <a :href="page.props.site.social?.tiktok" target="_blank" rel="noopener"
                            class="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors"
                            aria-label="TikTok">
